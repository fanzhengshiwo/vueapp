<el-tag :type="scope.row.status?'success':'danger'">{{ scope.row.status? '已上架':'未上架' }}</el-tag><template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="left" label="专栏内容" width="500">
      ...
      <el-table-column label="Actions" align="center" width="350" class-name="small-padding fixed-width">
        <template slot-scope="{row,$index}">
            ...
            <el-button  size="mini" type="warning" @click="handleDelete(row,$index)">
              <router-link :to="'/course/media'">
              目录
               </router-link>
            </el-button>
